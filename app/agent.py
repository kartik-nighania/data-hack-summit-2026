...
The graph builds lazily on first use — importing this module does no network I/O.
"""
import logging
import operator
import time
...
from app.config import AGENT_MODEL, get_lf, trace_url
